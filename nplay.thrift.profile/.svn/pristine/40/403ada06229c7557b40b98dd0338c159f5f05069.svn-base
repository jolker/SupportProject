...
public class TPromotionResult implements org.apache.thrift.TBase<TPromotionResult, TPromotionResult._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TPromotionResult");
  ...
  static {
    schemes.put(StandardScheme.class, new TPromotionResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TPromotionResultTupleSchemeFactory());
  }

  public short error; // required
  public List<TPromotion> listData; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TPromotionResult.class, metaDataMap);
  }

  public TPromotionResult() {
  }

  public TPromotionResult(
    short error,
    List<TPromotion> listData,
    int totalPage,
    int totalRecord)
  {
    this();
   ...
   */
  public TPromotionResult(TPromotionResult other) {
    __isset_bit_vector.clear();
    __isset_bit_vector.or(other.__isset_bit_vector);
    this.error = other.error;
    if (other.isSetListData()) {
      List<TPromotion> __this__listData = new ArrayList<TPromotion>();
      for (TPromotion other_element : other.listData) {
        __this__listData.add(new TPromotion(other_element));
      }
  ...
  public TPromotionResult deepCopy() {
    return new TPromotionResult(this);
  }
  ...
  public TPromotionResult setError(short error) {
    this.error = error;
    setErrorIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<TPromotion> getListDataIterator() {
    return (this.listData == null) ? null : this.listData.iterator();
  }

  public void addToListData(TPromotion elem) {
    if (this.listData == null) {
      this.listData = new ArrayList<TPromotion>();
    }
    this.listData.add(elem);
  }

  public List<TPromotion> getListData() {
    return this.listData;
  }

  public TPromotionResult setListData(List<TPromotion> listData) {
    this.listData = listData;
    return this;
  }
  ...
  public TPromotionResult setTotalPage(int totalPage) {
    this.totalPage = totalPage;
    setTotalPageIsSet(true);
    return this;
  }
  ...
  public TPromotionResult setTotalRecord(int totalRecord) {
    this.totalRecord = totalRecord;
    setTotalRecordIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case LIST_DATA:
      if (value == null) {
        ...
        setListData((List<TPromotion>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TPromotionResult)
      return this.equals((TPromotionResult)that);
    return false;
  }

  public boolean equals(TPromotionResult that) {
    if (that == null)
      return false;
  ...
  public int compareTo(TPromotionResult other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    TPromotionResult typedOther = (TPromotionResult)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TPromotionResult(");
    boolean first = true;
  ...
  private static class TPromotionResultStandardSchemeFactory implements SchemeFactory {
    public TPromotionResultStandardScheme getScheme() {
      return new TPromotionResultStandardScheme();
    }
  }

  private static class TPromotionResultStandardScheme extends StandardScheme<TPromotionResult> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TPromotionResult struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.listData = new ArrayList<TPromotion>(_list8.size);
                for (int _i9 = 0; _i9 < _list8.size; ++_i9)
                {
                  TPromotion _elem10; // required
                  _elem10 = new TPromotion();
                  _elem10.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPromotionResult struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.listData != null) {
        oprot.writeFieldBegin(LIST_DATA_FIELD_DESC);
        {
          ...
          for (TPromotion _iter11 : struct.listData)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TPromotionResultTupleSchemeFactory implements SchemeFactory {
    public TPromotionResultTupleScheme getScheme() {
      return new TPromotionResultTupleScheme();
    }
  }

  private static class TPromotionResultTupleScheme extends TupleScheme<TPromotionResult> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TPromotionResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetListData()) {
        {
          ...
          for (TPromotion _iter12 : struct.listData)
          {
            _iter12.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TPromotionResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.listData = new ArrayList<TPromotion>(_list13.size);
          for (int _i14 = 0; _i14 < _list13.size; ++_i14)
          {
            TPromotion _elem15; // required
            _elem15 = new TPromotion();
            _elem15.read(iprot);
